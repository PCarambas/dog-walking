...
// ! A getter function binds an object property to a function that will be called when that property is looked up.
...
// Add two getter functions. Make sure each function returns the copy of the right data.
